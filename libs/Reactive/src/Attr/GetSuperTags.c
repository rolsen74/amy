...
U32 AMYFUNC _main_Attr_GetSuperTags( struct ReactivePrivIFace *Self, struct RA_PrivObject *obj, ... )
{
U32 retval;
va_list ap;
...
U32 AMYFUNC _main_Attr_GetSuperList( struct ReactivePrivIFace *Self, struct RA_PrivObject *obj, struct TagItem *taglist )
{
struct TagItem *tag;
struct RAP_Get msg;
U32 retval;
