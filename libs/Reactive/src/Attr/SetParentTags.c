...
U32 AMY_FUNC _main_Attr_SetParentTags( struct ReactivePrivIFace *Self, struct RA_PrivObject *obj, ... )
{
U32 retval;
va_list ap;
...
U32 AMY_FUNC _main_Attr_SetParentList( struct ReactivePrivIFace *Self, struct RA_PrivObject *obj, struct TagItem *taglist )
{
struct TagItem *tag;
struct RAP_Set msg;
U32 retval;
