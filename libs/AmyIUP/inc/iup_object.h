...
/* SIZE to RASTERSIZE
 * \ingroup object */
#define iupWIDTH2RASTER(_w, _cw) iupRound( data, (_w * _cw)/4.0)
/* SIZE to RASTERSIZE
 * \ingroup object */
#define iupHEIGHT2RASTER(_h, _ch) iupRound( data, (_h * _ch)/8.0)

/* RASTERSIZE to SIZE
 * \ingroup object */
#define iupRASTER2WIDTH(_w, _cw) iupRound( data, (_w * 4.0)/_cw)
/* RASTERSIZE to SIZE
 * \ingroup object */
#define iupRASTER2HEIGHT(_h, _ch) iupRound( data, (_h * 8.0)/_ch)
...
IUP_SDK_API Ihandle *iupObjectCreate( struct libData *data, Iclass *ic, void **params );
