...
struct Iclass_
{
   ...
   */
  void *(*GetInnerNativeContainerHandle)( struct libData *data, Ihandle *ih, Ihandle *child );
   ...
   */
  void (*ChildAdded)( struct libData *data, Ihandle *ih, Ihandle *child );
   ...
   */
  void (*ComputeNaturalSize)( struct libData *data, Ihandle *ih, int *w, int *h, int *children_expand );
   ...
   * First call done at iupLayoutCompute for the dialog.
   */
  void (*SetChildrenCurrentSize)( struct libData *data, Ihandle *ih, int shrink );
   ...
   * First call done at iupLayoutCompute for the dialog.
   */
  void (*SetChildrenPosition)( struct libData *data, Ihandle *ih, int x, int y );
   ...
   */
  int (*DlgPopup)( struct libData *data, Ihandle *ih, int x, int y );   
};
 ...
 * \ingroup iclass */
IUP_SDK_API Iclass *iupClassNew( struct libData *data, Iclass *ic_parent );
 ...
 * \ingroup iclass */
typedef char *(*IattribGetFunc)( struct libData *data, Ihandle *ih );
 ...
 * Used by \ref iupClassRegisterAttribute.
 * \ingroup iclass */
typedef char *(*IattribGetIdFunc)( struct libData *data, Ihandle *ih, int id );
 ...
 * Used by \ref iupClassRegisterAttribute.
 * \ingroup iclass */
typedef char *(*IattribGetId2Func)( struct libData *data, Ihandle *ih, int id1, int id2 );
 ...
 * Used by \ref iupClassRegisterAttribute.
 * \ingroup iclass */
typedef int (*IattribSetFunc)( struct libData *data, Ihandle *ih, const char *value );
 ...
 * Used by \ref iupClassRegisterAttribute.
 * \ingroup iclass */
typedef int (*IattribSetIdFunc)( struct libData *data, Ihandle *ih, int id, const char *value );
 ...
 * Used by \ref iupClassRegisterAttribute.
 * \ingroup iclass */
typedef int (*IattribSetId2Func)( struct libData *data, Ihandle *ih, int id1, int id2, const char *value );
 ...
 * Set is called from iupAttribUpdate ( amy_IupMap), IupStoreAttribute and IupSetAttribute.
