...
int iupMaskParse(struct libData *data, const char *mask, ImaskParsed **imk );

/* Do the pattern matching on the given text. */
int iupMaskMatch( struct libData *data, const char *text, ImaskParsed *imk, long start, iMaskMatchFunc mask_func, void *user_data, char *addchar, int icase );
