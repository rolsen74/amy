...
ImaskMatchFunc* iupMaskMatchGetFuncs( struct libData *data )
{
...
int iupMaskMatch( struct libData *data, const char *text, ImaskParsed * fsm, long start, iMaskMatchFunc function, void *user, char *addchar, int icase)
{
  long ret;
