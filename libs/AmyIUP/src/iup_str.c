...
static void iStrInitLatin1_map( struct libData *data )
{
...
IUP_SDK_API int amy_iupStrCompareEqual( struct libData *data, const char *l, const char *r, int casesensitive, int utf8, int partial )
{
  if ( ! l || !r)
    return 0;
...
IUP_SDK_API int amy_iupStrCompareFind( struct libData *data, const char *l, const char *r, int casesensitive, int utf8 )
{
  ...
  for (i=0; i<count; i++)
  {
    if ( amy_iupStrCompareEqual( data, l, r, casesensitive, utf8, 1))
      return 1;
