...
S32 error;
	...
	IExec->DebugPrintF( "AmyBlanker : ROMInit 2\n" );
	...
	if ( ! libBase )
	{
		IExec->DebugPrintF( "AmyBlanker : Error creating Device" );
		goto bailout;
	}

	IExec->DebugPrintF( "AmyBlanker : ROMInit 3\n" );
	...
	IExec->DebugPrintF( "AmyBlanker : Rock'n Roll\n" );
	error = FALSE;
