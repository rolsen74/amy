...
/*   69 */ { offsetof( struct AmyCLibIFace, time_localtime ), EM_ALWAYS, __time_localtime },
/*   70 */ { offsetof( struct AmyCLibIFace, time_time ), EM_ALWAYS, __time_time },
/*   71 */ { offsetof( struct AmyCLibIFace, stdio_fopen ), EM_FILE, __fopen },
/*   72 */ { offsetof( struct AmyCLibIFace, stdio_ftell ), EM_FILE, __ftell },
/*   73 */ { offsetof( struct AmyCLibIFace, stdio_fgetpos ), EM_FILE, __fgetpos },
/*   74 */ { offsetof( struct AmyCLibIFace, stdio_flockfile ), EM_FILE, __flockfile },
/*   75 */ { offsetof( struct AmyCLibIFace, stdio_funlockfile ), EM_FILE, __funlockfile },
/*   76 */ { offsetof( struct AmyCLibIFace, stdio_fflush ), EM_FILE, __fflush },
/*   77 */ { offsetof( struct AmyCLibIFace, stdio_puts ), EM_FILE, __puts },
/*   78 */ { offsetof( struct AmyCLibIFace, stdio_putchar ), EM_FILE, __putchar },
/*   79 */ { offsetof( struct AmyCLibIFace, stdio_fputc ), EM_FILE, __fputc },
/*   80 */ { offsetof( struct AmyCLibIFace, stdio_setvbuf ), EM_FILE, __setvbuf },
/*   81 */ { offsetof( struct AmyCLibIFace, stdio_fclose ), EM_FILE, __fclose },
/*   82 */ { offsetof( struct AmyCLibIFace, stdio_fseek ), EM_FILE, __fseek },
/*   83 */ { offsetof( struct AmyCLibIFace, stdio_fseeko ), EM_FILE, __fseeko },
/*   84 */ { offsetof( struct AmyCLibIFace, stdio_vprintf ), EM_FILE, __vprintf },
/*   85 */ // { offsetof( struct AmyCLibIFace, stdio_sprintf ), EM_FILE, __sprintf },
/*   86 */ { offsetof( struct AmyCLibIFace, stdio_vsprintf ), EM_FILE, __vsprintf },
/*   87 */ { offsetof( struct AmyCLibIFace, stdio_vsnprintf ), EM_FILE, __vsnprintf },
...
/*   90 */ { offsetof( struct AmyCLibIFace, stdio_ungetc ), EM_FILE, __ungetc },
/*   91 */ { offsetof( struct AmyCLibIFace, stdio_fread ), EM_FILE, __fread },
/*   92 */ { offsetof( struct AmyCLibIFace, stdio_clearerr ), EM_FILE, __clearerr },
/*   92 */ { offsetof( struct AmyCLibIFace, stdlib_strtof ), EM_ALWAYS, __stdlib_strtof },
/*   93 */ { offsetof( struct AmyCLibIFace, stdlib_strtod ), EM_ALWAYS, __stdlib_strtod },
