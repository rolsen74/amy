...
/*  251 */	// unsigned long AMYFUNC( *stdlib_strtoul)( struct AmyCLib_IFace *Self, const char *, char **, int );
/*  252 */	// unsigned long long AMYFUNC( *stdlib_strtoul)( struct AmyCLib_IFace *Self, const char *, char **, int );
