...
/*   200 */	struct group *				AMY_FUNC ( *grp_getgrgid )( struct AmyCLibIFace *Self, gid_t );
/*   201 */	struct group *				AMY_FUNC ( *grp_getgrnam )( struct AmyCLibIFace *Self, const char * );
/*   202 */	struct passwd *				AMY_FUNC ( *pwd_getpwuid )( struct AmyCLibIFace *Self, uid_t );
/*   203 */	int							AMY_FUNC ( *unistd_chown )( struct AmyCLibIFace *Self, const char *, uid_t, gid_t cc );
/*   204 */	char *						AMY_FUNC ( *string_strrchr )( struct AmyCLibIFace *Self, const char *, int );
/*   205 */	struct passwd *				AMY_FUNC ( *pwd_getpwnam )( struct AmyCLibIFace *Self, const char * );
...
/*   221 */	int							AMY_FUNC ( *unistd_chdir )( struct AmyCLibIFace *Self, const char * );
/*   222 */	int							AMY_FUNC ( *stdlib_system )( struct AmyCLibIFace *Self, const char * );
/*   223 */	int							AMY_FUNC ( *string_strcoll )( struct AmyCLibIFace *Self, const char *, const char * );
/*   224 */	char *						AMY_FUNC ( *time_asctime )( struct AmyCLibIFace *Self, const struct tm * );
/*   225 */	int							AMY_FUNC ( *wchar_mbsinit )( struct AmyCLibIFace *Self, const mbstate_t * );
/*   226 */	void						AMY_FUNC ( *dirent_rewinddir )( struct AmyCLibIFace *Self, DIR * );
/*   227 */	uid_t						AMY_FUNC ( *unistd_getuid )( struct AmyCLibIFace *Self );
/*   228 */	int							AMY_FUNC ( *unistd_fsync )( struct AmyCLibIFace *Self, int );
/*   229 */	gid_t						AMY_FUNC ( *unistd_getgid )( struct AmyCLibIFace *Self );
/*   230 */	int							AMY_FUNC ( *sys_statvfs_statvfs )( struct AmyCLibIFace *Self, const char *, struct statvfs * );
/*   231 */	int							AMY_FUNC ( *sys_mount_statfs )( struct AmyCLibIFace *Self, const char *, struct statfs * );
/*   232 */	void						AMY_FUNC ( *pwd_setpwent )( struct AmyCLibIFace *Self );
/*   233 */	void						AMY_FUNC ( *grp_setgrent )( struct AmyCLibIFace *Self );
/*   234 */	int							AMY_FUNC ( *stropts_ioctl_ap )( struct AmyCLibIFace *Self, int, int, va_list ap );
/*   235 */	DIR *						AMY_FUNC ( *dirent_fdopendir )( struct AmyCLibIFace *Self, int fildes );
/*   236 */	FILE *						AMY_FUNC ( *stdio_fdopen )( struct AmyCLibIFace *Self, int, const char * );
/*   237 */	int							AMY_FUNC ( *sys_resource_getrlimit )( struct AmyCLibIFace *Self, int resource, struct rlimit *rlp );
/*   238 */	int							AMY_FUNC ( *signal_kill )( struct AmyCLibIFace *Self, pid_t, int );
/*   239 */	int							AMY_FUNC ( *unistd_usleep )( struct AmyCLibIFace *Self, useconds_t );
/*   240 */	int							AMY_FUNC ( *stdlib_putenv )( struct AmyCLibIFace *Self, char * );
/*   241 */	int							AMY_FUNC ( *unistd_execvp )( struct AmyCLibIFace *Self, const char *, char * const bb[] );
/*   242 */	char *						AMY_FUNC ( *string_strsignal )( struct AmyCLibIFace *Self, int );
/*   243 */	char *						AMY_FUNC ( *unistd_ttyname )( struct AmyCLibIFace *Self, int );
/*   244 */	int							AMY_FUNC ( *unistd_setgid )( struct AmyCLibIFace *Self, gid_t );
/*   245 */	int							AMY_FUNC ( *unistd_setuid )( struct AmyCLibIFace *Self, uid_t );
/*   246 */	int							AMY_FUNC ( *unistd_setgroups )( struct AmyCLibIFace *Self, int ngroups, const gid_t *gidset );
/*   247 */	int							AMY_FUNC ( *unistd_execv )( struct AmyCLibIFace *Self, const char *, char * const bb[] );
/*   248 */	char *						AMY_FUNC ( *unistd_crypt )( struct AmyCLibIFace *Self, const char *, const char * );
...
/*   284 */	long long					AMY_FUNC ( *stdlib_llabs )( struct AmyCLibIFace *Self, long long );
/*   285 */	lldiv_t						AMY_FUNC ( *stdlib_lldiv )( struct AmyCLibIFace *Self, long long, long long );
/*   286 */	long double					AMY_FUNC ( *complex_cabsl )( struct AmyCLibIFace *Self, _Complex long double );
/*   287 */	int							AMY_FUNC ( *stdio_vscanf )( struct AmyCLibIFace *Self, const char *, va_list );
/*   288 */	float						AMY_FUNC ( *complex_cargf )( struct AmyCLibIFace *Self, _Complex float );
/*   289 */	_Complex float				AMY_FUNC ( *complex_ccosf )( struct AmyCLibIFace *Self, _Complex float );
/*   290 */	_Complex float				AMY_FUNC ( *complex_ccoshf )( struct AmyCLibIFace *Self, _Complex float );
/*   291 */	_Complex float				AMY_FUNC ( *complex_cexpf )( struct AmyCLibIFace *Self, _Complex float );
/*   292 */	_Complex float				AMY_FUNC ( *complex_clogf )( struct AmyCLibIFace *Self, _Complex float );
/*   293 */	_Complex float				AMY_FUNC ( *complex_csinf )( struct AmyCLibIFace *Self, _Complex float );
/*   294 */	_Complex float				AMY_FUNC ( *complex_csinhf )( struct AmyCLibIFace *Self, _Complex float );
/*   295 */	_Complex float				AMY_FUNC ( *complex_csqrtf )( struct AmyCLibIFace *Self, _Complex float );
/*   296 */	_Complex float				AMY_FUNC ( *complex_ctanf )( struct AmyCLibIFace *Self, _Complex float );
/*   297 */	_Complex float				AMY_FUNC ( *complex_ctanhf )( struct AmyCLibIFace *Self, _Complex float );
/*   298 */	_Complex float				AMY_FUNC ( *complex_cpowf )( struct AmyCLibIFace *Self, _Complex float, _Complex float );
/*   299 */	_Complex float				AMY_FUNC ( *complex_cprojf )( struct AmyCLibIFace *Self, _Complex float );
/*   300 */	double						AMY_FUNC ( *complex_cabs )( struct AmyCLibIFace *Self, _Complex double );
/*   301 */	double						AMY_FUNC ( *complex_carg )( struct AmyCLibIFace *Self, _Complex double );
/*   302 */	_Complex double				AMY_FUNC ( *complex_ccos )( struct AmyCLibIFace *Self, _Complex double );
/*   303 */	_Complex double				AMY_FUNC ( *complex_ccosh )( struct AmyCLibIFace *Self, _Complex double );
/*   304 */	_Complex double				AMY_FUNC ( *complex_cexp )( struct AmyCLibIFace *Self, _Complex double );
/*   305 */	_Complex double				AMY_FUNC ( *complex_clog )( struct AmyCLibIFace *Self, _Complex double );
/*   306 */	_Complex double				AMY_FUNC ( *complex_csin )( struct AmyCLibIFace *Self, _Complex double );
/*   307 */	_Complex double				AMY_FUNC ( *complex_csinh )( struct AmyCLibIFace *Self, _Complex double );
/*   308 */	_Complex double				AMY_FUNC ( *complex_csqrt )( struct AmyCLibIFace *Self, _Complex double );
/*   309 */	_Complex double				AMY_FUNC ( *complex_ctan )( struct AmyCLibIFace *Self, _Complex double );
/*   310 */	_Complex double				AMY_FUNC ( *complex_ctanh )( struct AmyCLibIFace *Self, _Complex double );
/*   311 */	_Complex double				AMY_FUNC ( *complex_cpow )( struct AmyCLibIFace *Self, _Complex double, _Complex double );
/*   312 */	_Complex double				AMY_FUNC ( *complex_cproj )( struct AmyCLibIFace *Self, _Complex double );
/*   313 */	_Complex long double		AMY_FUNC ( *complex_cargl )( struct AmyCLibIFace *Self, _Complex long double );
/*   314 */	_Complex long double		AMY_FUNC ( *complex_ccosl )( struct AmyCLibIFace *Self, _Complex long double );
/*   315 */	_Complex long double		AMY_FUNC ( *complex_ccoshl )( struct AmyCLibIFace *Self, _Complex long double );
/*   316 */	_Complex long double		AMY_FUNC ( *complex_cexpl )( struct AmyCLibIFace *Self, _Complex long double );
/*   317 */	_Complex long double		AMY_FUNC ( *complex_clogl )( struct AmyCLibIFace *Self, _Complex long double );
/*   318 */	_Complex long double		AMY_FUNC ( *complex_csinl )( struct AmyCLibIFace *Self, _Complex long double );
/*   319 */	_Complex long double		AMY_FUNC ( *complex_csinhl )( struct AmyCLibIFace *Self, _Complex long double );
/*   320 */	_Complex long double		AMY_FUNC ( *complex_csqrtl )( struct AmyCLibIFace *Self, _Complex long double );
/*   321 */	_Complex long double		AMY_FUNC ( *complex_ctanl )( struct AmyCLibIFace *Self, _Complex long double );
/*   322 */	_Complex long double		AMY_FUNC ( *complex_ctanhl )( struct AmyCLibIFace *Self, _Complex long double );
...
/*   327 */	float						AMY_FUNC ( *math_f_acos )( struct AmyCLibIFace *Self, float );
/*   328 */	float						AMY_FUNC ( *math_f_asin )( struct AmyCLibIFace *Self, float );
/*   329 */	float						AMY_FUNC ( *math_f_atan2 )( struct AmyCLibIFace *Self, float, float );
/*   330 */	float						AMY_FUNC ( *math_f_atan )( struct AmyCLibIFace *Self, float );
/*   331 */	float						AMY_FUNC ( *math_f_ceil )( struct AmyCLibIFace *Self, float );
/*   332 */	float						AMY_FUNC ( *math_f_cos )( struct AmyCLibIFace *Self, float );
/*   333 */	float						AMY_FUNC ( *math_f_cosh )( struct AmyCLibIFace *Self, float );
/*   334 */	float						AMY_FUNC ( *math_f_exp )( struct AmyCLibIFace *Self, float );
/*   335 */	float						AMY_FUNC ( *math_f_fabs )( struct AmyCLibIFace *Self, float );
/*   336 */	float						AMY_FUNC ( *math_f_floor )( struct AmyCLibIFace *Self, float );
/*   337 */	float						AMY_FUNC ( *math_f_fmod )( struct AmyCLibIFace *Self, float, float );
/*   338 */	float						AMY_FUNC ( *math_f_frexp )( struct AmyCLibIFace *Self, float, int * );
/*   339 */	float						AMY_FUNC ( *math_f_sqrt )( struct AmyCLibIFace *Self, float );
/*   340 */	float						AMY_FUNC ( *math_f_hypot )( struct AmyCLibIFace *Self, float, float );
/*   341 */	float						AMY_FUNC ( *math_f_ldexp )( struct AmyCLibIFace *Self, float, int );
/*   342 */	float						AMY_FUNC ( *math_f_log10 )( struct AmyCLibIFace *Self, float );
/*   343 */	float						AMY_FUNC ( *math_f_log )( struct AmyCLibIFace *Self, float );
/*   344 */	float						AMY_FUNC ( *math_f_modf )( struct AmyCLibIFace *Self, float, float * );
/*   345 */	float						AMY_FUNC ( *math_f_pow )( struct AmyCLibIFace *Self, float, float );
/*   346 */	float						AMY_FUNC ( *math_f_sin )( struct AmyCLibIFace *Self, float );
/*   347 */	float						AMY_FUNC ( *math_f_sinh )( struct AmyCLibIFace *Self, float );
/*   348 */	float						AMY_FUNC ( *math_f_tan )( struct AmyCLibIFace *Self, float );
/*   349 */	float						AMY_FUNC ( *math_f_tanh )( struct AmyCLibIFace *Self, float );
/*   350 */	long double					AMY_FUNC ( *math_l_fabs )( struct AmyCLibIFace *Self, long double );
/*   351 */	long double					AMY_FUNC ( *math_l_acos )( struct AmyCLibIFace *Self, long double );
/*   352 */	long double					AMY_FUNC ( *math_l_asin )( struct AmyCLibIFace *Self, long double );
/*   353 */	long double					AMY_FUNC ( *math_l_atan )( struct AmyCLibIFace *Self, long double );
/*   354 */	long double					AMY_FUNC ( *math_l_atan2 )( struct AmyCLibIFace *Self, long double, long double );
/*   355 */	long double					AMY_FUNC ( *math_l_ceil )( struct AmyCLibIFace *Self, long double );
/*   356 */	long double					AMY_FUNC ( *math_l_cos )( struct AmyCLibIFace *Self, long double );
/*   357 */	long double					AMY_FUNC ( *math_l_cosh )( struct AmyCLibIFace *Self, long double );
/*   358 */	long double					AMY_FUNC ( *math_l_exp )( struct AmyCLibIFace *Self, long double );
/*   359 */	long double					AMY_FUNC ( *math_l_floor )( struct AmyCLibIFace *Self, long double );
/*   360 */	long double					AMY_FUNC ( *math_l_frexp )( struct AmyCLibIFace *Self, long double, int * );
/*   361 */	long double					AMY_FUNC ( *math_l_sqrt )( struct AmyCLibIFace *Self, long double );
/*   362 */	long double					AMY_FUNC ( *math_l_hypot )( struct AmyCLibIFace *Self, long double, long double );
/*   363 */	long double					AMY_FUNC ( *math_l_ldexp )( struct AmyCLibIFace *Self, long double, int );
/*   364 */	long double					AMY_FUNC ( *math_l_log )( struct AmyCLibIFace *Self, long double );
/*   365 */	long double					AMY_FUNC ( *math_l_log10 )( struct AmyCLibIFace *Self, long double );
/*   366 */	long double					AMY_FUNC ( *math_l_modf )( struct AmyCLibIFace *Self, long double, long double * );
/*   367 */	long double					AMY_FUNC ( *math_l_pow )( struct AmyCLibIFace *Self, long double, long double );
/*   368 */	long double					AMY_FUNC ( *math_l_sin )( struct AmyCLibIFace *Self, long double );
