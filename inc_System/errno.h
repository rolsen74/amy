...
/*
** Based on The Open Group Base Specifications Issue 7 and
...
#include <Amy_Public.h>		// get 'AmyCLibPublic'
...
// Error number compatible with Roadshow() and clib2
...
// Extra error numbers compatible with newlib
