...
#ifndef AMYLIB_LIBRARIES_AMYCLIBPRIV_H
#define AMYLIB_LIBRARIES_AMYCLIBPRIV_H
...
struct _AmyCLibPublic
{
	...
	struct PrivFile *	ra_stderr;		// Stdio.h
	struct PrivFile *	ra_stdin;		// Stdio.h
	struct PrivFile *	ra_stdout;		// Stdio.h
