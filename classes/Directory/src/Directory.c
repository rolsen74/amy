...
#include "Get_IOErr_String.c"
#include "Parse_Path.c"

#include "RAM_Dir_Clear.c"
#include "RAM_Dir_GetEntry.c"
#include "RAM_Dir_IsDir.c"
#include "RAM_Dir_IsFile.c"
#include "RAM_Dir_Scan.c"
#include "RAM_Dir_Sort.c"
...
static struct RA_Plugin USED Dir_Plugin =
{
/* RA_Plugin_MatchWord		*/ ID_RAPlugin,
/* RA_Plugin_MatchTag		*/ & Dir_Plugin,
